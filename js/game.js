class Game {
    ...
    play() {
        ...
        this.ran.html(rank+"position");
        this.ran.position(width/2,height/2);
        this.ran.style('font-size','100px');
        this.ran.style('color',color(255,0,0))
    }
}